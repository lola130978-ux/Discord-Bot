...
function parseWithdrawalRequest(text) {
    ...
    for (
        ...
        if (
            /gems?|diamonds?|titanic|random huge/i
                .test(name)
        ) {
            continue;
        }
    ...
    async interaction => {
        ...
        if (
            ...
            if (
                ...
                try {
                    ...
                    // IMPORTANT:
                    // Fetch the actual members.
                    // This prevents the old bug where XP
                    // only went to the person running it.
        ...
        if (
            ...
            if (
                ...
                // Remove the actual requested assets
